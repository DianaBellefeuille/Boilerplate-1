...
public class OI {
  ...
  public Button mWristChange = new JoystickButton(driverJoystick, 4);

  public Button mIntake = new JoystickButton(driverJoystick, 5);
  public Button mOutput = new JoystickButton(driverJoystick, 6);
